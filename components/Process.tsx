            ...
            <div className="max-w-7xl mx-auto">
                ...
                >
                    <h2 className="text-4xl sm:text-6xl text-white font-serif mb-6">
                        ...
                        <span className="text-[#B9FF3E]">Success</span>
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                    {steps.map((step, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="group relative p-8 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-[#B9FF3E]/30 hover:bg-white/[0.04] transition-all duration-500"
                        >
                            {/* Step Number */}
                            <div className="absolute top-4 right-4 text-6xl font-bold text-white/5 group-hover:text-[#B9FF3E]/10 transition-colors">
                                {String(index + 1).padStart(2, "0")}
                            </div>

                            <div className="relative z-10">
                                <div className="w-14 h-14 rounded-xl bg-[#B9FF3E]/10 flex items-center justify-center mb-6 group-hover:bg-[#B9FF3E]/20 transition-colors">
                                    <step.icon className="w-7 h-7 text-[#B9FF3E]" />
                                </div>
