...
export default function Stats() {
    return (
        <section className="bg-[#0E0E0F] py-32 px-4 sm:px-6 border-t border-white/5 relative overflow-hidden">
            {/* Background glow */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#B9FF3E]/5 rounded-full blur-[200px]" />
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                >
                    <h2 className="text-4xl sm:text-6xl md:text-7xl text-white font-serif leading-tight">
                        ...
                        experiences that
                        <br />
                        <span className="text-[#B9FF3E]">scale.</span>
                    </h2>
                </motion.div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
                    {stats.map((stat, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="group relative p-6 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-[#B9FF3E]/30 hover:bg-white/[0.04] transition-all duration-500 text-center md:text-left"
                        >
